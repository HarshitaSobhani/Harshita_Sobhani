...
- **Sentinel** (this repo, `/backend`, `/frontend`, `/docs`) — Gujarat Police Innovation Hackathon 2026 submission: a hybrid CCTV Registry+GIS (Model 1) and Unified Viewing & Analytics (Model 2) platform, with ANPR-based watchlist alerting and cross-camera vehicle tracking. See [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) for setup and design.
